@echo off
echo Starting server on internal port 8080 and external port 5637...
echo --------------------
echo Starting internal server on port 8080...
start "Internal Server" python -m uvicorn main:app --reload --host 0.0.0.0 --port 8080
echo Starting external server on port 5637...
start "External Server" python -m uvicorn main:app --reload --host 0.0.0.0 --port 5637
echo --------------------
